...
# [![MapMitra logo][]][MapMitra.dev] 

MapMitra is a real time android application which serves
to track continuous location of the user and warn the user
by avoking a dialog box, a notification and a strong vibration
so that when a user is driving he he should get alert of upcoming obstacles.
...
[mapmitra-announce@googlegroups.com](https://groups.google.com/forum/#!forum/flutter-announce)
mailing list.

## About MapMitra

We think MapMitra will help in saving peoples
lifes and also can be used by Government of
respeced country to get road status.
...
[MapMitra logo]: https://github.com/yashsalunke/yashsalunke.github.io/blob/master/Project_Icon%20(1).png
[MapMitra.dev]: https://yashsalunke.github.io
